  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="p-2 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 rounded-2xl md:w-780">
          <div className="flex justify-between">
            <p className="font-semibold text-xl mr-4">Revenue Updates</p>
